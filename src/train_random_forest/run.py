...
def go(args):
    ...
    # YOUR CODE HERE
    ######################################
    artifact = wandb.Artifact(args.output_artifact, type="model_export",metadata=rf_config , description="Random Forest Model Export")
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    ('random_forest', random_Forest)  # Use the RandomForestRegressor
])
